...
let(:versions) do
  ...
  it 'resolves a wildcard micro version' do
    expect(described_class.resolve(tokenized_version('1.7.+'), versions)).to eq(tokenized_version('1.7.0_71'))
  ...
  it 'resolves a wildcard qualifier' do
    expect(described_class.resolve(tokenized_version('1.7.0_+'), versions)).to eq(tokenized_version('1.7.0_71'))
